...
# YOLO setup
model_weights_path = os.getenv('MODEL_WEIGHTS_PATH', 'yolov3-tiny.weights')
model_cfg_path = os.getenv('MODEL_CFG_PATH', 'yolov3-tiny.cfg')
coco_names_path = os.getenv('COCO_NAMES_PATH', 'coco.names')
